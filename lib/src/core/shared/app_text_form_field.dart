    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          labelStyle: AppTextStyles.style16w500.getTextStyle,
          ...
          hintStyle: AppTextStyles.style14w400.getTextStyle.copyWith(color: AppColors.grey),
          border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(widget.borderRadius ?? 12.0),
            borderSide: BorderSide(color: AppColors.primaryColor, width: widget.isBorder! ? 1 : 1),
          ),
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(widget.borderRadius ?? 12.0),
            borderSide: BorderSide(color: AppColors.primaryColor, width: widget.isBorder! ? 2 : 1),
          ),
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(widget.borderRadius ?? 12.0),
            borderSide: BorderSide(
                color: widget.enabledBorderColor ?? AppColors.grey.withOpacity(.5), width: widget.isBorder! ? 1 : 2),
          ),
          errorBorder: OutlineInputBorder(
            borderRadius: BorderRadius.all(Radius.circular(widget.borderRadius ?? 12.0)),
            borderSide: BorderSide(color: AppColors.redErrorDefault, width: widget.isBorder! ? 1 : 2),
          ),
        ),
